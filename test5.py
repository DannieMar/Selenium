...
def registro():
	...
	time.sleep(3)
	driver.find_element(By.ID, "sign-username").send_keys("daniel2356789")
	driver.find_element(By.ID, "sign-password").send_keys("2345689")
	time.sleep(2)
...
def login():
	...
	time.sleep(3)
	driver.find_element(By.ID, "loginusername").send_keys("daniel2356789")
	driver.find_element(By.ID, "loginpassword").send_keys("2345689")
	time.sleep(2)
